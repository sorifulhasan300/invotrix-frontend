...
export function getProductColumns({
  ...
  return [
    ...
    },
    {
      ...
      header: () => (
        <SortableHeader field="stockQuantity" sortBy={sortBy} sortOrder={sortOrder} onSort={onSort}>
          Stock
        </SortableHeader>
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: () => (
        <SortableHeader field="purchasePrice" sortBy={sortBy} sortOrder={sortOrder} onSort={onSort}>
          Buying Price
        </SortableHeader>
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: () => (
        <SortableHeader field="sellingPrice" sortBy={sortBy} sortOrder={sortOrder} onSort={onSort}>
          Selling Price
        </SortableHeader>
      ),
      cell: ({ row }) => {
