  ...
  return (
    <div className="space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">Real-time business insights at a glance.</p>
      </div>
      ...
      <section className="space-y-4">
        ...
        {isLoading ? (
          ...
          <Card className="border-emerald-200/60 bg-emerald-50/50 dark:border-emerald-900/30 dark:bg-emerald-950/20">
